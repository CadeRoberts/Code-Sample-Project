...
I mostly made this to learn how to program and it ended up being fun, so I continue working on it when I feel like it. 
...
It is, to my knowledge, bug-free, scalable, and written in a way that others can easily understand.
   - In the "Scripts" folder: the files titled...
       ...
       - **"CreatureCaught"** - when an animal is caught in a picture, this randomizes stats to describe it/the location, creates an object (o_polaroid) to store these stats 
                           and make a custom photo/journal entry using this information
       - **"birdstates"** - contains all of the functions for the bird animals in the game (the individual types of birds having different variations of these funstions)
   ...
   - In the "objects" folder: the files titled...
      -  **"o_polaroid"** - this object displays the picture the player just took in a fun ans satisfying way by drawing shapes and sprites with various 
                       timers and alpha gradients.
      -  **"o_polaroidCycle"** - this object stores the pictures you take and allows you to cycle through them later.
